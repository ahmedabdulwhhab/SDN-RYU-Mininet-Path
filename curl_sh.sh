...
#TYPE SELECT , WATCH PORT IS 2 , TWO ACTIONS
curl -X POST -d '{"dpid": 1,"type": "SELECT","group_id": 3,"buckets": [{"WEIGHT":30,"watch_port": 2,"actions": [{"type": "OUTPUT","port": 2}]},{"WEIGHT":70,"watch_port": 3,"actions": [{"type": "OUTPUT","port": 3}]}]}' http://localhost:8080/stats/groupentry/add
