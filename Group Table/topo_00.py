...
'''
    ...
    net.addLink(s4, h3, bw=20.0, delay='1900ms', use_htb=True)
    
    net.addLink(s4, s3, bw=20.0, delay='400ms', use_htb=True)
    net.addLink(s3, h2, bw=20.0, delay='500ms', use_htb=True)
