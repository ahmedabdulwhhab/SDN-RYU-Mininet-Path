...
class ProjectController(app_manager.RyuApp):
    ...
    def get_paths(self, src, dst):
        ...
        while stack:
            ...
            print(" set(self.adjacency[node].keys()) - set(path) is ", set(self.adjacency[node].keys()) - set(path))
  ...
  #self.install_paths(      h1[0],       h1[1],      h2[0],       h2[1],   src_ip, dst_ip)
    ...
    def _packet_in_handler(self, ev):
        ...
        if src not in self.hosts:
            ...
            print("inside packetin, sel.hosts is ",self.hosts)
            print("inside packetin,  src not in self.hosts , dst is ",dst)
            #after first h2 ping -c3 h1
