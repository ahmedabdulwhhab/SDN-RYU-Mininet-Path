...
proj_location = "/home/ubuntu/sdn/projects/a9khan/multipath_net_classifier_mod_path/"
## command to run ##
cmd = "sudo ryu-manager "+proj_location+ "app5_multi-path+monitor.py    ryu.app.ofctl_rest /home/ubuntu/sdn/sources/flowmanager/flowmanager.py   --observe-links --ofp-tcp-listen-port 6644"
