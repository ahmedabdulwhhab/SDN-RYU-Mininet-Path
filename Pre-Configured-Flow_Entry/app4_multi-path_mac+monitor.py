...
#sudo ryu-manager /home/ubuntu/sdn/projects/multi-path/app3_multi-path_mac+monitor.py  /home/ubuntu/sdn/sources/flowmanager/flowmanager.py ryu.app.ofctl_rest   --observe-links --ofp-tcp-listen-port 6653
...
class Switch(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
            ...
            #add_flowentry_rules(datapath,            eth_dst           eth_src = None, priority = 1, fwd_port = None,inport=None):
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:02', 10, 1,2)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:03', 10, 1,2)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:04', 10, 1,2)#same dst same fwport
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:01', 10, 3,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:01', 10, 3,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:01', 10, 3,1)
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:02', 10, 3,2)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:02', 10, 3,2)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:03', 10, 3,2)
        elif dpid == 2: # switch S2  
            ### Implement ICMP Forwarding
            #add_flowentry_rules(datapath,            eth_dst           eth_src = None, priority = 1, fwd_port = None,inport=None):
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:01', 10, 1,3)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:03', 10, 1,3)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:04', 10, 1,3)#same dst same fwport
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:02', 10, 2,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:02', 10, 2,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:02', 10, 2,1)
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:03', 10, 2,3)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:03', 10, 2,3)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:04', 10, 2,3)

        elif dpid == 3: # switch S3 
            ### Implement ICMP Forwarding
            #add_flowentry_rules(datapath,            eth_dst           eth_src = None, priority = 1, fwd_port = None,inport=None):
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:01', 10, 1,3)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:02', 10, 1,3)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:04', 10, 1,3)#same dst same fwport
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:03', 10, 2,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:03', 10, 2,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:03', 10, 2,1)
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:04', 10, 2,3)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:04', 10, 2,3)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:01', 10, 2,3)
        elif dpid == 4: # switch S4           
            ### Implement ICMP Forwarding
            #add_flowentry_rules(datapath,            eth_dst           eth_src = None, priority = 1, fwd_port = None,inport=None):            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:01', 10, 1,3)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:03', 10, 1,3)#same dst same fwport
            self.add_flowentry_rules(datapath, '00:00:00:00:00:04','00:00:00:00:00:02', 10, 1,3)#same dst same fwport
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:04', 10, 2,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:01','00:00:00:00:00:04', 10, 2,1)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:04', 10, 2,1)
            
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:01', 10, 2,3)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:02','00:00:00:00:00:01', 10, 2,3)
            self.add_flowentry_rules(datapath, '00:00:00:00:00:03','00:00:00:00:00:02', 10, 2,3)
    ...
    def add_flowentry_rules(self, datapath, eth_dst = None,eth_src = None, priority = 1, fwd_port = None,inport=None):
        parser = datapath.ofproto_parser
