...
class Switch(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
            ...
            #add_flowentry_rules(datapath, ip_proto, ipv4_dst = None, priority = 1, fwd_port = None):
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.1', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.3', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 10, 3)
            """
            ### implement ICMP Forwarding
            #add_flowentry_rules(datapath, ip_proto, ipv4_dst = None, priority = 1, fwd_port = None):
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.1', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.3', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.4', 10, 3)
            """
            ### Implement UDP Forwarding
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.1', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.3', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.4', 10, 3)
            ...
            """            
            #add_flowentry_rules(datapath, ip_proto, ipv4_dst = None, priority = 1, fwd_port = None):
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.1', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.3', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 10, 3)
            """            
            ### Implement ICMP Forwarding
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.1', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.3', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.2', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.4', 10, 3)
            """            
            ### Implement UDP Forwarding
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.1', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.3', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.2', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.4', 10, 2)
            """
        elif dpid == 3: # switch S3
            ### Implement TCP Forwarding
            """            
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.1', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.3', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 10, 3)
            """            
            ### Implement ICMP Forwarding
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.1', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.3', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.4', 10, 3)
            """            
            ### Implement UDP Forwarding
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.1', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.3', 10, 1)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.4', 10, 3)
            ...
            ### Implement TCP Forwarding
            """            
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.1', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.3', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 10, 1)
            """            
            ### Implement ICMP Forwarding
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.1', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.3', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.4', 10, 1)
            """            
            ### Implement UDP Forwarding
            #add_flowentry_rules(datapath, ip_proto, ipv4_dst = None, priority = 1, fwd_port = None):
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.1', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.3', 10, 3)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.2', 10, 2)
            self.add_flowentry_rules(datapath, inet.IPPROTO_UDP, '10.0.0.4', 10, 1)
            """
    ...
    def add_flowentry_rules(self, datapath, ip_proto, ipv4_dst = None, priority = 1, fwd_port = None):
        parser = datapath.ofproto_parser
